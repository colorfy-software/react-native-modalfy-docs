...
* [Opening & closing](guides/opening-closing.md)
* [Passing params](guides/params.md)
* [Triggering a callback](guides/triggering-a-callback.md)
* [Type checking with TypeScript](guides/typing.md)
* [Subscribing to events](guides/events.md)
* [Using outside React](guides/outside-react.md)
* [Upgrading from v2.x](guides/upgrading.md)
...
* [createModalStack](api/createmodalstack.md)
* [useModal](api/usemodal.md)
* [withModal](api/withmodal.md)
* [modalfy](api/modalfy.md)

## 📰 Blog

* [Unveiling Modalfy v3](blog/unveiling-modalfy-v3.md)
* [Announcing Modalfy v2](blog/modalfy-v2.md)
